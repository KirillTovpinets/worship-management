...
import { LyricsModal } from "@/app/dashboard/songs/components/LyricsModal";
import { MultipleMP3Upload } from "@/app/dashboard/songs/components/MultipleMP3Upload";
import { MultiplePDFUpload } from "@/app/dashboard/songs/components/MultiplePDFUpload";
import {
  ModalProvider,
  useModalContext,
} from "@/app/dashboard/songs/contexts/ModalContext";
                ...
                <RoleGuard
                  fallback={
                    <div className="space-y-4 p-8 text-center">
                      <p className="text-gray-600">Текст песни не загружен</p>
                    </div>
                  }
                >
